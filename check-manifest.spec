...
%prep
%setup -q -n check-manifest-0.44
cd %{_builddir}/check-manifest-0.44
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608051755
...
cp %{_builddir}/check-manifest-0.44/LICENSE.rst %{buildroot}/usr/share/package-licenses/check-manifest/b82514746d0268c7a2fca13e10d9d6daafa544c9
