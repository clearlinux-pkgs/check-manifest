...
Version  : 0.46
Release  : 24
URL      : https://files.pythonhosted.org/packages/ff/bc/8271d03edf705a2ddd6226b0ce60b8d75e7fcc183c1ddabb9cd9e9c850c3/check-manifest-0.46.tar.gz
...
%prep
%setup -q -n check-manifest-0.46
cd %{_builddir}/check-manifest-0.46
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1627352700
...
cp %{_builddir}/check-manifest-0.46/LICENSE.rst %{buildroot}/usr/share/package-licenses/check-manifest/b82514746d0268c7a2fca13e10d9d6daafa544c9
