...
Version  : 0.43
Release  : 19
URL      : https://files.pythonhosted.org/packages/28/7e/7320775f6d032a62cfb1569dfb4ad995d9137e5ef287291f6eb6e9d7ea13/check-manifest-0.43.tar.gz
Source0  : https://files.pythonhosted.org/packages/28/7e/7320775f6d032a62cfb1569dfb4ad995d9137e5ef287291f6eb6e9d7ea13/check-manifest-0.43.tar.gz
...
%prep
%setup -q -n check-manifest-0.43
cd %{_builddir}/check-manifest-0.43
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600786704
...
cp %{_builddir}/check-manifest-0.43/LICENSE.rst %{buildroot}/usr/share/package-licenses/check-manifest/b82514746d0268c7a2fca13e10d9d6daafa544c9
